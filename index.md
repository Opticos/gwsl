...
*  Does WSL work on Windows 10 versions older than 2004? *Yes, now that Microsoft has made WSL2 compatible on older versions of Windows, GWSL can run on them too. To run GWSL on older versions of Windows 10, you will need to use the traditional installer.*
